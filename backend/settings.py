...
# Trust X-Forwarded-Proto header from nginx (needed for CSRF behind HTTPS proxy)
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='ai_hype_db'),
...
SIMPLE_JWT = {
    ...
    'COOKIE_SETTINGS': {
        'HTTP_ONLY': True,  # httpOnly cookies for security
        'SECURE': not DEBUG,  # Use secure cookies in production (HTTPS only)
